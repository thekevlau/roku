...
kevin_quotes = [
    ...
    """Always be the weakest person in the room and focus on sponging from
        everyone else. Revel in your failure as it is the symptom
        of growth.""",
    ...
    """Accept that it's a natural feeling that you're nervous. Don't be
        afraid of it and re-focus on the task at hand. If you're all the time
        monitoring, questioning and second guessing yourself, instead of
        trying to do what you've practiced, you'll make it harder for
        yourself.""",
